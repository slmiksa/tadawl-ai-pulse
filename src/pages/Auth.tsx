      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="text-white space-y-8">
          <div className="flex flex-col items-center space-y-4">
            <div className="w-48 h-48 rounded-3xl flex items-center justify-center backdrop-blur-sm border border-white/20 bg-white/10 shadow-lg hover:scale-105 transition-all duration-300 animate-fade-in">
              <img src="/lovable-uploads/tadawl-ai-main-logo.png" alt="TadawlAI Logo" className="w-40 h-40 object-contain" />
            </div>
