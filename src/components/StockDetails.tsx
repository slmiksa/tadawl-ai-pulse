  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="max-w-7xl mx-auto p-4 space-y-6">
        {/* Enhanced Price Section with Unified Frame */}
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className={cn(
              "flex items-center space-x-3 px-6 py-3 rounded-xl border-2 text-lg font-semibold",
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4 border-t border-gray-700">
            <div className="text-center">
              <p className="text-sm text-gray-400">الأعلى اليوم</p>
              <p className="text-lg font-semibold text-green-400">${(price * 1.02).toFixed(2)}</p>
            </div>
            <div className="text-center">
              <p className="text-sm text-gray-400">الأدنى اليوم</p>
              <p className="text-lg font-semibold text-red-400">${(price * 0.98).toFixed(2)}</p>
            </div>
            <div className="text-center">
              <p className="text-sm text-gray-400">حجم التداول</p>
              <p className="text-lg font-semibold text-blue-400">1.2M</p>
            </div>
            <div className="text-center">
              <p className="text-sm text-gray-400">القيمة السوقية</p>
              <p className="text-lg font-semibold text-purple-400">2.8B</p>
            </div>
          </div>
        </div>
